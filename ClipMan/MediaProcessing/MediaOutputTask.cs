...
namespace ClipMan.MediaProcessing
{
    internal class MediaOutputTask : IDisposable
    {
        ...
        /// <summary>
        /// A count of how many of each warning was generated whilst processing this clip
        /// </summary>
        public Dictionary<MediaProcessingWarning, int> Warnings { get; } = new();
        ...
        public void AddWarning(MediaProcessingWarning warning)
        {
