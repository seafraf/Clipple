...
public class Settings : ObservableObject
{
    ...
    private bool ingestAutomatically;
    ...
    private bool defaultDeleteVideos;
    ...
    private bool defaultRemoveClips;
    ...
    [BsonIgnore] public string ThemeKey => $"{(ThemeIsDark ? "Dark" : "Light")}.{ThemeColour}";
