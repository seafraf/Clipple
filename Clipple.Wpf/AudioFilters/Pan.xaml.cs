...
public partial class Pan
{
    public class ViewModel : AudioFilter
    {
        ...
        [BsonIgnore] public override string FilterString => $"pan={ChannelLayout}|{ChannelMapping}";

        [BsonIgnore] public override string FilterName => "Pan";
        ...
        {
            new("Duplicate left", "Stereo", "c0=c0|c1=c0", "stereo"),
            new("Duplicate right", "Stereo", "c0=c1|c1=c1", "stereo")
        };
